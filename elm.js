...
var $author$project$Main$MonthOverviewMsg = function (a) {
	return {$: 'MonthOverviewMsg', a: a};
};
var $author$project$Main$MonthlyOverviewPage = function (a) {
	return {$: 'MonthlyOverviewPage', a: a};
};
...
var $author$project$Pages$Dashboard$UserResponded = function (a) {
	return {$: 'UserResponded', a: a};
};
var $author$project$Constants$api_url = 'http://localhost:3000/http://localhost:3333';
...
var $author$project$Constants$token = '1b698504-7ee2-49c5-b888-4ef414f5e0bab1f75f53-59f5-46e7-9532-d5cf6ec95bb793676725-819f-493a-93c0-a273d4cb0d38';
var $author$project$Types$User = F3(
	function (mail, displayName, id) {
		return {displayName: displayName, id: id, mail: mail};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Pages$Dashboard$userInfoDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Types$User,
	A2($elm$json$Json$Decode$field, 'mail', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'displayName', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string));
var $author$project$Pages$Dashboard$doGetUserInfo = $elm$http$Http$request(
	{
		body: $elm$http$Http$jsonBody(
			$elm$json$Json$Encode$object(_List_Nil)),
		expect: A2($elm$http$Http$expectJson, $author$project$Pages$Dashboard$UserResponded, $author$project$Pages$Dashboard$userInfoDecoder),
		headers: _List_fromArray(
			[
				A2($elm$http$Http$header, 'Hades-Login-Token', $author$project$Constants$token)
			]),
		method: 'GET',
		timeout: $elm$core$Maybe$Nothing,
		tracker: $elm$core$Maybe$Nothing,
		url: $author$project$Constants$api_url + '/rest/users/loginuserinfo'
	});
var $author$project$Pages$Dashboard$init = _Utils_Tuple2(
	{lastReading: $krisajenkins$remotedata$RemoteData$NotAsked, user: $krisajenkins$remotedata$RemoteData$Loading},
	$author$project$Pages$Dashboard$doGetUserInfo);
var $author$project$Pages$Login$init = {error: $elm$core$Maybe$Nothing, password: '', username: ''};
var $author$project$Pages$MonthOverview$UserResponded = function (a) {
	return {$: 'UserResponded', a: a};
};
var $author$project$Pages$MonthOverview$userInfoDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Types$User,
	A2($elm$json$Json$Decode$field, 'mail', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'displayName', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string));
var $author$project$Pages$MonthOverview$doGetUserInfo = $elm$http$Http$request(
	{
		body: $elm$http$Http$jsonBody(
			$elm$json$Json$Encode$object(_List_Nil)),
		expect: A2($elm$http$Http$expectJson, $author$project$Pages$MonthOverview$UserResponded, $author$project$Pages$MonthOverview$userInfoDecoder),
		headers: _List_fromArray(
			[
				A2($elm$http$Http$header, 'Hades-Login-Token', $author$project$Constants$token)
			]),
...
var $author$project$Pages$MonthOverview$init = _Utils_Tuple2(
	{hovering: _List_Nil, readings: $krisajenkins$remotedata$RemoteData$NotAsked, user: $krisajenkins$remotedata$RemoteData$Loading},
	$author$project$Pages$MonthOverview$doGetUserInfo);
var $author$project$Pages$Signup$init = {email: '', error: $elm$core$Maybe$Nothing, password: '', repeatPassword: '', username: ''};
			...
			switch (maybeRoute.a.$) {
				case 'Landing':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{page: $author$project$Main$Landing, user: $elm$core$Maybe$Nothing}),
						$elm$core$Platform$Cmd$none);
				case 'Login':
				...
				case 'Signup':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$SignupPage($author$project$Pages$Signup$init)
							}),
						$elm$core$Platform$Cmd$none);
				case 'Dashboard':
					var _v4 = maybeRoute.a;
					var _v5 = $author$project$Pages$Dashboard$init;
					var dashboardModel = _v5.a;
					var dashboardCmd = _v5.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$DashboardPage(dashboardModel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$DashboardMsg, dashboardCmd));
				default:
					var _v6 = maybeRoute.a;
					var _v7 = $author$project$Pages$MonthOverview$init;
					var monthOverview = _v7.a;
					var monthCmd = _v7.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$MonthlyOverviewPage(monthOverview)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$MonthOverviewMsg, monthCmd));
			}
		}
	});
...
var $author$project$Route$MonthlyOverview = {$: 'MonthlyOverview'};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$MonthlyOverview,
			$elm$url$Url$Parser$s('month')),
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return A2(
			...
			{key: key, page: $author$project$Main$Landing, user: $elm$core$Maybe$Nothing});
	});
...
var $author$project$Pages$Dashboard$LastReadingResponded = function (a) {
	return {$: 'LastReadingResponded', a: a};
};
var $author$project$Types$Reading = F2(
	function (value, date) {
		return {date: date, value: value};
	});
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $author$project$Pages$Dashboard$lastReadingDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Types$Reading,
...
var $author$project$Pages$Dashboard$getLastReading = $elm$http$Http$request(
	{
		body: $elm$http$Http$jsonBody(
			$elm$json$Json$Encode$object(_List_Nil)),
		expect: A2($elm$http$Http$expectJson, $author$project$Pages$Dashboard$LastReadingResponded, $author$project$Pages$Dashboard$lastReadingDecoder),
		headers: _List_fromArray(
			[
				A2($elm$http$Http$header, 'Hades-Login-Token', $author$project$Constants$token)
			]),
		...
		timeout: $elm$core$Maybe$Nothing,
		tracker: $elm$core$Maybe$Nothing,
		url: $author$project$Constants$api_url + '/rest/readings/last'
	});
var $author$project$Pages$Dashboard$update = F2(
	function (msg, model) {
		if (msg.$ === 'UserResponded') {
			var result = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						user: $krisajenkins$remotedata$RemoteData$fromResult(result)
					}),
				function () {
					if (result.$ === 'Ok') {
						return $author$project$Pages$Dashboard$getLastReading;
					} else {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						lastReading: $krisajenkins$remotedata$RemoteData$fromResult(result)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Pages$Login$LoggedInAs = {$: 'LoggedInAs'};
var $author$project$Pages$Login$NoOp = {$: 'NoOp'};
var $author$project$Pages$Login$RequestSignup = {$: 'RequestSignup'};
var $author$project$Pages$Login$LoginResponded = function (a) {
	return {$: 'LoginResponded', a: a};
};
var $author$project$Pages$Login$redirectToDecoder = A2($elm$json$Json$Decode$field, 'redirectTo', $elm$json$Json$Decode$string);
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Pages$Login$doLogin = F2(
		...
		return $elm$http$Http$request(
			{
				...
				expect: A2($elm$http$Http$expectJson, $author$project$Pages$Login$LoginResponded, $author$project$Pages$Login$redirectToDecoder),
				headers: _List_fromArray(
					[
				...
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
				url: $author$project$Constants$api_url + '/rest/users/login'
			});
	});
		...
		switch (msg.$) {
			case 'UsernameChanged':
				...
				return _Utils_Tuple3(
					_Utils_update(
						...
						{username: v}),
					$elm$core$Platform$Cmd$none,
					$author$project$Pages$Login$NoOp);
			...
			case 'SubmitClicked':
				return _Utils_Tuple3(
					...
					A2($author$project$Pages$Login$doLogin, model.username, model.password),
					$author$project$Pages$Login$NoOp);
			case 'GotoSignupClicked':
				return _Utils_Tuple3(model, $elm$core$Platform$Cmd$none, $author$project$Pages$Login$RequestSignup);
			default:
				if (msg.a.$ === 'Ok') {
					return _Utils_Tuple3(model, $elm$core$Platform$Cmd$none, $author$project$Pages$Login$LoggedInAs);
				} else {
					return _Utils_Tuple3(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Login failed. Check your credentials.')
							}),
						$elm$core$Platform$Cmd$none,
						$author$project$Pages$Login$NoOp);
				}
...
var $author$project$Pages$MonthOverview$ReadingResponded = function (a) {
	return {$: 'ReadingResponded', a: a};
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Pages$MonthOverview$readingDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Types$Reading,
	A2($elm$json$Json$Decode$field, 'value', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'date', $elm$json$Json$Decode$string));
var $author$project$Pages$MonthOverview$readingsDecoder = A2(
	$elm$json$Json$Decode$field,
	'readings',
	$elm$json$Json$Decode$list($author$project$Pages$MonthOverview$readingDecoder));
var $author$project$Pages$MonthOverview$loadReadingsForMonth = $elm$http$Http$request(
	{
		body: $elm$http$Http$jsonBody(
			$elm$json$Json$Encode$object(_List_Nil)),
		expect: A2($elm$http$Http$expectJson, $author$project$Pages$MonthOverview$ReadingResponded, $author$project$Pages$MonthOverview$readingsDecoder),
		headers: _List_fromArray(
			[
				A2($elm$http$Http$header, 'Hades-Login-Token', $author$project$Constants$token)
			]),
		...
		timeout: $elm$core$Maybe$Nothing,
		tracker: $elm$core$Maybe$Nothing,
		url: $author$project$Constants$api_url + '/rest/readings/2026/2'
	});
var $author$project$Pages$MonthOverview$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UserResponded':
				var result = msg.a;
				return _Utils_Tuple2(
					...
					function () {
						if (result.$ === 'Ok') {
							return $author$project$Pages$MonthOverview$loadReadingsForMonth;
						} else {
							return $elm$core$Platform$Cmd$none;
						}
					}());
			case 'ReadingResponded':
				var result = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							readings: $krisajenkins$remotedata$RemoteData$fromResult(result)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var hovering = msg.a;
...
var $author$project$Pages$Signup$NoOp = {$: 'NoOp'};
var $author$project$Pages$Signup$RequestLogin = {$: 'RequestLogin'};
var $author$project$Pages$Signup$SignedUp = {$: 'SignedUp'};
		...
		switch (msg.$) {
			case 'UsernameChanged':
				...
				return _Utils_Tuple3(
					_Utils_update(
						...
						{username: v}),
					$elm$core$Platform$Cmd$none,
					$author$project$Pages$Signup$NoOp);
			case 'EmailChanged':
				var v = msg.a;
				return _Utils_Tuple3(
					_Utils_update(
			...
			case 'RepeatPasswordChanged':
				...
				return _Utils_Tuple3(
					...
					$author$project$Pages$Signup$NoOp);
			case 'SubmitClicked':
				return (!_Utils_eq(model.password, model.repeatPassword)) ? _Utils_Tuple3(
					_Utils_update(
						model,
						{
					...
					$elm$core$Platform$Cmd$none,
					$author$project$Pages$Signup$NoOp) : _Utils_Tuple3(model, $elm$core$Platform$Cmd$none, $author$project$Pages$Signup$SignedUp);
			default:
				return _Utils_Tuple3(model, $elm$core$Platform$Cmd$none, $author$project$Pages$Signup$RequestLogin);
		}
	});
...
var $author$project$Pages$Dashboard$userOf = function (model) {
	return $krisajenkins$remotedata$RemoteData$toMaybe(model.user);
};
var $author$project$Pages$MonthOverview$userOf = function (model) {
	return $krisajenkins$remotedata$RemoteData$toMaybe(model.user);
};
		...
		switch (msg.$) {
			...
			case 'NavBarMsg':
				switch (msg.a.$) {
					case 'LogoutClicked':
						...
						return _Utils_Tuple2(
							...
							A2(
								$elm$browser$Browser$Navigation$pushUrl,
								model.key,
								$author$project$Route$toPath($author$project$Route$Landing)));
					case 'LoginClicked':
						var _v2 = msg.a;
						return _Utils_Tuple2(
							model,
					...
					default:
						var location = msg.a.a;
						return _Utils_Tuple2(
							model,
							A2(
								$elm$browser$Browser$Navigation$pushUrl,
								model.key,
								$author$project$Route$toPath(location)));
				}
			case 'LoginMsg':
				var subMsg = msg.a;
				var _v3 = model.page;
				if (_v3.$ === 'LoginPage') {
					var subModel = _v3.a;
					var _v4 = A2($author$project$Pages$Login$update, subMsg, subModel);
						...
						case 'RequestSignup':
							return _Utils_Tuple2(
								...
								A2(
									$elm$browser$Browser$Navigation$pushUrl,
									model.key,
									$author$project$Route$toPath($author$project$Route$Signup)));
						default:
							return _Utils_Tuple2(
								model,
								A2(
			...
			case 'SignupMsg':
				...
				if (_v6.$ === 'SignupPage') {
					var subModel = _v6.a;
					var _v7 = A2($author$project$Pages$Signup$update, subMsg, subModel);
						...
						case 'NoOp':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										page: $author$project$Main$SignupPage(newSubModel)
									}),
								A2($elm$core$Platform$Cmd$map, $author$project$Main$SignupMsg, subCmd));
						case 'RequestLogin':
							return _Utils_Tuple2(
								model,
								A2(
			...
			case 'DashboardMsg':
				var subMsg = msg.a;
				var _v9 = model.page;
				if (_v9.$ === 'DashboardPage') {
					var subModel = _v9.a;
					var _v10 = A2($author$project$Pages$Dashboard$update, subMsg, subModel);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								user: $author$project$Pages$Dashboard$userOf(newSubModel)
							}),
			...
			default:
				var subMsg = msg.a;
				var _v11 = model.page;
				if (_v11.$ === 'MonthlyOverviewPage') {
					var subModel = _v11.a;
					var _v12 = A2($author$project$Pages$MonthOverview$update, subMsg, subModel);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$MonthlyOverviewPage(newSubModel),
								user: $author$project$Pages$MonthOverview$userOf(newSubModel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$MonthOverviewMsg, subCmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$NavBar$LogoutClicked = {$: 'LogoutClicked'};
var $author$project$NavBar$NavElementClicked = function (a) {
	return {$: 'NavElementClicked', a: a};
};
...
var $author$project$CommonStyles$buttonStyle = _List_fromArray(
	[
		A3(
		$rtfeldman$elm_css$Css$border3,
		$rtfeldman$elm_css$Css$px(2),
		$rtfeldman$elm_css$Css$solid,
		$rtfeldman$elm_css$Css$hex('#00008b')),
...
var $author$project$NavBar$navBarButtonsStyle = _List_fromArray(
	[
...
var $author$project$NavBar$navBarElements = _List_fromArray(
	[
		{displayText: 'Monatsübersicht', location: '{{CONTEXT}}/month'},
		{displayText: 'Jahresübersicht', location: '{{CONTEXT}}/year'},
		{displayText: 'Vergleichen', location: '{{CONTEXT}}/compare'},
		{displayText: 'Datenqualität', location: '{{CONTEXT}}/dataquality'},
		{displayText: 'Monatswerte', location: '{{CONTEXT}}/monthly-values'},
		{displayText: 'Berichte', location: '{{CONTEXT}}/reports'},
		{displayText: 'Temperaturdecke', location: '{{CONTEXT}}/blanket'}
	]);
...
var $author$project$NavBar$navBarRight = _List_fromArray(
	[
...
var $author$project$NavBar$navBarStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$backgroundColor(
		$rtfeldman$elm_css$Css$hex('#00008b')),
		$rtfeldman$elm_css$Css$color(
...
var $author$project$NavBar$navHeadingStyle = _List_fromArray(
	[
...
var $author$project$NavBar$userToName = function (user) {
	if (user.$ === 'Just') {
		var u = user.a;
...
var $author$project$NavBar$navBar = function (user) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$nav,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$NavBar$navBarStyle)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$NavBar$navHeadingStyle)
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Aeolus')
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$NavBar$navBarButtonsStyle)
							]),
						A2(
							$elm$core$List$map,
							function (e) {
								return A2(
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$CommonStyles$buttonStyle),
											$rtfeldman$elm_css$Html$Styled$Events$onClick(
											$author$project$NavBar$NavElementClicked($author$project$Route$MonthlyOverview))
										]),
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text(e.displayText)
										]));
							},
							$author$project$NavBar$navBarElements)),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$NavBar$navBarRight)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Nachrichten: 0')
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										'(' + ($author$project$NavBar$userToName(user) + ')'))
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$button,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$CommonStyles$buttonStyle),
										$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$NavBar$LogoutClicked)
									]),
								_List_fromArray(
									[
...
var $author$project$NavBar$LoginClicked = {$: 'LoginClicked'};
var $author$project$NavBar$unauthNavBar = A2(
	$rtfeldman$elm_css$Html$Styled$nav,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$NavBar$navBarStyle)
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$CommonStyles$buttonStyle),
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$NavBar$LoginClicked)
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('anmelden')
								]))
						]))
				]))
		]));
...
var $author$project$Pages$Dashboard$viewLastReading = function (remoteReading) {
	switch (remoteReading.$) {
		case 'NotAsked':
			return _List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('XY.Z °C')
						])),
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('vom: DD.MM.YYYY')
						]))
				]);
		case 'Loading':
			return _List_fromArray(
		...
		case 'Failure':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Couldn\'t load the last reading.')
						]))
				]);
		default:
			var reading = remoteReading.a;
			return _List_fromArray(
				[
					A2(
					$rtfeldman$elm_css$Html$Styled$h1,
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text(
							A2($myrho$elm_round$Round$round, 1, reading.value) + ' °C')
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$p,
					_List_Nil,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('vom: ' + reading.date)
						]))
				]);
	}
};
var $author$project$Pages$Dashboard$view = function (model) {
	return _List_fromArray(
		[
			...
			$rtfeldman$elm_css$Html$Styled$div,
			_List_Nil,
			$author$project$Pages$Dashboard$viewLastReading(model.lastReading))
		]);
};
...
var $author$project$Pages$Landing$landingCenterContainer = _List_fromArray(
	[
...
var $author$project$Pages$Landing$logoStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$maxWidth(
		$rtfeldman$elm_css$Css$vw(25)),
		$rtfeldman$elm_css$Css$maxHeight(
		$rtfeldman$elm_css$Css$vh(25))
	]);
var $rtfeldman$elm_css$Html$Styled$Attributes$src = function (url) {
	return A2($rtfeldman$elm_css$Html$Styled$Attributes$stringProperty, 'src', url);
};
var $author$project$Pages$Landing$view = _List_fromArray(
	[
		A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Pages$Landing$landingCenterContainer)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Pages$Landing$logoStyle),
						$rtfeldman$elm_css$Html$Styled$Attributes$src('favicon.png'),
						$rtfeldman$elm_css$Html$Styled$Attributes$alt('Aeolus')
					]),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$h1,
...
var $author$project$Pages$Login$GotoSignupClicked = {$: 'GotoSignupClicked'};
var $author$project$Pages$Login$PasswordChanged = function (a) {
	return {$: 'PasswordChanged', a: a};
};
var $author$project$Pages$Login$SubmitClicked = {$: 'SubmitClicked'};
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$color(
							$rtfeldman$elm_css$Css$hex('#b00020')),
							$rtfeldman$elm_css$Css$textAlign($rtfeldman$elm_css$Css$center)
						]))
				]),
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
												...
												[
													...
													_List_fromArray(
														[
															...
															$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Login$UsernameChanged)
														]),
													_List_Nil)
												]))
										])),
												...
												[
													...
													_List_fromArray(
														[
															...
															$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Login$PasswordChanged)
														]),
													_List_Nil)
												]))
										])),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Pages$Login$SubmitClicked),
															$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$CommonStyles$buttonStyle)
														]),
													_List_fromArray(
														[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Pages$Login$GotoSignupClicked),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('No account? Signup')
								]))
						]))
				]))
		]);
};
var $author$project$Pages$MonthOverview$OnHover = function (a) {
	return {$: 'OnHover', a: a};
};
	...
	if (_v1.$ === 'Dot') {
		...
		return $elm$core$Maybe$Just(
			A2(
				...
				{color: meta.color, datum: meta.datum, identification: meta.identification, isReal: meta.isReal, name: meta.name, presentation: dot, toAny: $terezka$elm_charts$Internal$Item$Dot, tooltipText: meta.tooltipText, x1: meta.x1, x2: meta.x2, y: meta.y},
				item));
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $author$project$Pages$MonthOverview$fromRataDie = function (z0) {
	var z = z0 + 719468;
...
var $author$project$Pages$MonthOverview$formatRataDie = function (n) {
	var pad = function (x) {
		return A3(
	...
	var _v0 = $author$project$Pages$MonthOverview$fromRataDie(n);
	var day = _v0.day;
	var month = _v0.month;
...
var $terezka$elm_charts$Internal$Svg$distancePoints = F3(
	function (plane, searched, point) {
		return A2(
			$elm$core$Basics$pow,
...
var $terezka$elm_charts$Internal$Svg$keepOne = function (toPosition) {
	...
	var func = F2(
		function (one, acc) {
			...
			if (_v0.$ === 'Nothing') {
				...
				return _Utils_eq(
					toPosition(other),
					toPosition(one)) ? A2($elm$core$List$cons, one, acc) : ((_Utils_cmp(
					toArea(other),
	...
	return A2(
		$elm$core$Basics$composeR,
		A2($elm$core$List$foldr, func, _List_Nil),
		$elm$core$List$reverse);
};
var $terezka$elm_charts$Internal$Svg$getNearest = F5(
	function (toPosition, items, _v0, plane, searched) {
		...
		var distance = function (item) {
			return A3(
				$terezka$elm_charts$Internal$Svg$distancePoints,
				plane,
				searched,
				toPoint(item));
		};
		var getClosest = F2(
			function (item, allClosest) {
				var _v1 = $elm$core$List$head(allClosest);
				if (_v1.$ === 'Just') {
					var closest = _v1.a;
					return _Utils_eq(
						toPoint(closest),
						...
						distance(closest),
						distance(item)) > 0) ? _List_fromArray(
						[item]) : allClosest);
				} else {
					return _List_fromArray(
						[item]);
...
var $terezka$elm_charts$Internal$Events$getNearest = function (grouping) {
	...
	return $terezka$elm_charts$Internal$Events$Decoder(
		F4(
			function (items, oldPlane, plane, searched) {
				var groups = A2($terezka$elm_charts$Internal$Many$apply, grouping, items);
				return A5($terezka$elm_charts$Internal$Svg$getNearest, toPos, groups, oldPlane, plane, searched);
			}));
};
...
var $author$project$Pages$MonthOverview$toRataDie = F3(
	function (year, month, day) {
		var y = (month <= 2) ? (year - 1) : year;
		var mp = A2($elm$core$Basics$modBy, 12, month + 9);
		var era = (((y >= 0) ? y : (y - 399)) / 400) | 0;
		var yoe = y - (era * 400);
		var doy = (((((153 * mp) + 2) / 5) | 0) + day) - 1;
		var doe = (((yoe * 365) + ((yoe / 4) | 0)) - ((yoe / 100) | 0)) + doy;
		return ((era * 146097) + doe) - 719468;
	});
var $author$project$Pages$MonthOverview$parseDateToRataDie = function (dateString) {
	var _v0 = A2($elm$core$String$split, '-', dateString);
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.b.b)) {
		...
		return A4(
			$elm$core$Maybe$map3,
			$author$project$Pages$MonthOverview$toRataDie,
...
var $terezka$elm_charts$Internal$Item$getLimitsIn = F2(
	function (plane, _v0) {
		var item = _v0.b;
		return A3($terezka$elm_charts$Internal$Coordinates$convertPos, plane, item.localPlane, item.limits);
	});
...
var $terezka$elm_charts$Chart$tooltip = F4(
	function (i, edits, attrs_, content) {
		return $terezka$elm_charts$Chart$html(
			function (p) {
				var pos = A2($terezka$elm_charts$Internal$Item$getLimitsIn, p, i);
				...
				return A3($terezka$elm_charts$Internal$Svg$isWithinPlane, p, pos.x1, pos.y2) ? A5(
					...
					p,
					A2($terezka$elm_charts$Internal$Item$getPositionIn, p, i),
					edits,
					attrs_,
...
var $author$project$Pages$MonthOverview$renderChart = F2(
		...
		var points = A2(
			...
			function (reading) {
				return A2(
					$elm$core$Maybe$map,
					function (rd) {
						return {x: rd, y: reading.value};
					},
					$author$project$Pages$MonthOverview$parseDateToRataDie(reading.date));
			},
			readings);
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('month-chart'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$width(
							...
							A2($rtfeldman$elm_css$Css$property, 'aspect-ratio', '2 / 1'),
							$rtfeldman$elm_css$Css$marginLeft(
							$rtfeldman$elm_css$Css$pct(25)),
							$rtfeldman$elm_css$Css$marginTop(
							$rtfeldman$elm_css$Css$px(50))
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$terezka$elm_charts$Chart$Attributes$height(450),
								...
								$author$project$Pages$MonthOverview$OnHover,
								...
								$author$project$Pages$MonthOverview$OnHover(_List_Nil))
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$terezka$elm_charts$Chart$Attributes$amount(8),
										$terezka$elm_charts$Chart$Attributes$format(
										function (x) {
											return $author$project$Pages$MonthOverview$formatRataDie(
									...
									[
										...
										_List_fromArray(
											[
												...
												$terezka$elm_charts$Chart$Attributes$color('#00008b')
											]),
										_List_fromArray(
											[$terezka$elm_charts$Chart$Attributes$circle]))
									]),
												...
												_List_fromArray(
													[
														...
														A2(
															...
															1,
															$terezka$elm_charts$Chart$Item$getY(item)) + ' °C')
													]))
											]);
									}))
							])))
...
var $author$project$Pages$MonthOverview$view = function (model) {
	var _v0 = model.readings;
	switch (_v0.$) {
		case 'NotAsked':
			return _List_fromArray(
				[
		...
		case 'Failure':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Couldn\'t load readings.')
						]))
				]);
		default:
			var readings = _v0.a;
			return _List_fromArray(
				[
					A2($author$project$Pages$MonthOverview$renderChart, readings, model)
				]);
	}
};
var $author$project$Pages$Signup$EmailChanged = function (a) {
	return {$: 'EmailChanged', a: a};
};
var $author$project$Pages$Signup$GotoLoginClicked = {$: 'GotoLoginClicked'};
var $author$project$Pages$Signup$PasswordChanged = function (a) {
	return {$: 'PasswordChanged', a: a};
};
var $author$project$Pages$Signup$RepeatPasswordChanged = function (a) {
	return {$: 'RepeatPasswordChanged', a: a};
};
var $author$project$Pages$Signup$SubmitClicked = {$: 'SubmitClicked'};
var $author$project$Pages$Signup$UsernameChanged = function (a) {
	return {$: 'UsernameChanged', a: a};
};
var $author$project$Pages$Signup$viewError = function (error) {
	if (error.$ === 'Just') {
		var message = error.a;
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
				...
				[
					...
					_List_fromArray(
						[
								...
								[
												...
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$Attributes$type_('text'),
															$rtfeldman$elm_css$Html$Styled$Attributes$value(model.username),
															$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Signup$UsernameChanged)
														]),
													_List_Nil)
												]))
										])),
												...
												[
													...
													_List_fromArray(
														[
															...
															$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Signup$EmailChanged)
														]),
													_List_Nil)
												]))
										])),
												...
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$Attributes$type_('password'),
															$rtfeldman$elm_css$Html$Styled$Attributes$value(model.password),
															$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Signup$PasswordChanged)
														]),
													_List_Nil)
												]))
										])),
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$text('Repeat password:')
												])),
											A2(
											$rtfeldman$elm_css$Html$Styled$td,
											_List_Nil,
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$Attributes$type_('password'),
															$rtfeldman$elm_css$Html$Styled$Attributes$value(model.repeatPassword),
															$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Signup$RepeatPasswordChanged)
														]),
													_List_Nil)
												]))
										])),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Pages$Signup$SubmitClicked),
															$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$CommonStyles$buttonStyle)
														]),
													_List_fromArray(
														[
							...
							$author$project$Pages$Signup$viewError(model.error),
							A2(
							$rtfeldman$elm_css$Html$Styled$a,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Pages$Signup$GotoLoginClicked),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$underline),
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Already have an account? Login')
								]))
						]))
				]))
		]);
...
var $author$project$Main$mainContent = function (model) {
	...
	switch (_v0.$) {
		case 'Landing':
			return A2(
				$elm$core$List$cons,
				A2($rtfeldman$elm_css$Html$Styled$map, $author$project$Main$NavBarMsg, $author$project$NavBar$unauthNavBar),
				$author$project$Pages$Landing$view);
		case 'LoginPage':
			var subModel = _v0.a;
			return A2(
				$elm$core$List$map,
				$rtfeldman$elm_css$Html$Styled$map($author$project$Main$LoginMsg),
				$author$project$Pages$Login$view(subModel));
		case 'SignupPage':
			var subModel = _v0.a;
			return A2(
				$elm$core$List$map,
				$rtfeldman$elm_css$Html$Styled$map($author$project$Main$SignupMsg),
				$author$project$Pages$Signup$view(subModel));
		case 'DashboardPage':
			var subModel = _v0.a;
			return A2(
				$elm$core$List$cons,
				A2(
					...
					$author$project$NavBar$navBar(model.user)),
				A2(
					$elm$core$List$map,
					$rtfeldman$elm_css$Html$Styled$map($author$project$Main$DashboardMsg),
					$author$project$Pages$Dashboard$view(subModel)));
		default:
			var subModel = _v0.a;
			return A2(
				$elm$core$List$cons,
				...
				A2(
					$elm$core$List$map,
					$rtfeldman$elm_css$Html$Styled$map($author$project$Main$MonthOverviewMsg),
					$author$project$Pages$MonthOverview$view(subModel)));
	}
};
